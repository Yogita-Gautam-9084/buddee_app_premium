...
class SearchHobbies extends StatefulWidget {
  const SearchHobbies({Key? key}) : super(key: key);

  @override
  State<SearchHobbies> createState() => _SearchHobbiesState();
}

class _SearchHobbiesState extends State<SearchHobbies> {
  List<String> items = [
